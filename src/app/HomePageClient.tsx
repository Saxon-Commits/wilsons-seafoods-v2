            ...
            <div className="relative z-10">
                ...
                <section className="relative h-[100vh] flex items-center justify-center">
                    ...
                    <motion.div
                        ...
                        className="sticky top-1/2 -translate-y-1/2 z-20 text-center px-4 max-w-5xl mx-auto"
                    >
                ...
                {/* Spacer to extend hero visibility */}
                <div className="h-[30vh] bg-gradient-to-b from-transparent via-blue-950/50 to-blue-950"></div>

                {/* Rest of content with background */}
                <div className="bg-gradient-to-b from-blue-950 via-blue-900 to-slate-900 relative z-10">
