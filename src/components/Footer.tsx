...
const SocialIcon: React.FC<{ href: string, children: React.ReactNode }> = ({ href, children }) => (
    <a href={href} className="text-slate-400 hover:text-brand-blue transition-colors duration-300" target="_blank" rel="noopener noreferrer">
        {children}
    </a>
);
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link href="/products" className="text-slate-400 hover:text-brand-blue transition-colors">Products</Link></li>
                            <li><Link href="/about" className="text-slate-400 hover:text-brand-blue transition-colors">About Us</Link></li>
                            <li><Link href="/blog" className="text-slate-400 hover:text-brand-blue transition-colors">Blog</Link></li>
                            <li><Link href="/reviews" className="text-slate-400 hover:text-brand-blue transition-colors">Reviews</Link></li>
